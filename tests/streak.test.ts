import { calculateStreak } from '../backend/src/services/streakEngine';
...
describe('Streak Calculation Logic', () => {
  ...
  it('should calculate a current streak of 1 for today', () => {
    ...
    const result = calculateStreak(completions, DAILY);
  ...
  it('should handle weekly frequency (simplified)', () => {
    ...
    const result = calculateStreak(completions, WEEKLY);
